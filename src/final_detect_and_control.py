...
class ballDetect:
    ...
    def motorCmd(self, stepper_A, stepper_B, stepper_C):
        stepper_A = int(stepper_A * 16 /1.8)
        stepper_B = int(stepper_B * 16 /1.8)
        stepper_C = int(stepper_C * 16 /1.8)
        msg = Vector3()
    ...
    def detect(self):
        ...
        while ret:
            ...
            if(self.is_finish == True):
                ...
                x_controller_output = 0
                y_controller_output = 0
                ...
                self.inverseKinematics(0, 0, 100, y_controller_output, x_controller_output)
